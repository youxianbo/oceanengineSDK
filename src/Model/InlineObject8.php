...
class InlineObject8 implements ModelInterface, ArrayAccess
{
     ...
     * Sets start_date
     *
     * @param string $start_date 开始时间，格式YYYY-MM-DD
     *
     * @return $this
     */
     ...
     * Sets end_date
     *
     * @param string $end_date 结束时间，格式YYYY-MM-DD
     *
     * @return $this
     */
     ...
     *
     * @param string $transaction_type 流水类型，详见附录【流水类型】. 允许值: \"RECHARGE\", \"TRANSFER\"
     *
     * @return $this
     */
     ...
     * Sets page
     *
     * @param string|null $page 页码. 默认值: 1
     *
     * @return $this
     */
     ...
     * Sets page_size
     *
     * @param string|null $page_size 页面数据量. 默认值: 10
     *
     * @return $this
     */
