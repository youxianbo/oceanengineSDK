...
/**
 * AdvertiserListCompanyList Class Doc Comment
 *
 * @category Class
 * @package  Oceanengine\Open
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AdvertiserListCompanyList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdvertiserList_company_list';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['customer_company_id'] === null) {
            $invalidProperties[] = "'customer_company_id' can't be null";
        }
        if ($this->container['customer_company_name'] === null) {
            $invalidProperties[] = "'customer_company_name' can't be null";
        }
     ...
     *
     * @param float $customer_company_id 客户公司id
     *
     * @return $this
     */
     ...
     *
     * @param string $customer_company_name 客户公司名
     *
     * @return $this
     */
