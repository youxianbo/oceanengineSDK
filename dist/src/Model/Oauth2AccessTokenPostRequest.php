...
/**
 * Oauth2AccessTokenPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Oceanengine\Open
 * @author   OpenAPI Generator team
 ...
 */
class Oauth2AccessTokenPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_oauth2_access_token__post_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('grant_type', $data ?? [], 'auth_code');
