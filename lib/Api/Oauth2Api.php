...
class Oauth2Api
{
     ...
     * @param  string $x_debug_mode 允许值：1（开启） (optional)
     ...
     */
    public function oauth2AccessTokenPost($content_type, $x_debug_mode = null, $inline_object = null)
    {
        list($response) = $this->oauth2AccessTokenPostWithHttpInfo($content_type, $x_debug_mode, $inline_object);
        return $response;
    }
     ...
     */
    public function oauth2AccessTokenPostWithHttpInfo($content_type, $x_debug_mode = null, $inline_object = null)
    {
        $request = $this->oauth2AccessTokenPostRequest($content_type, $x_debug_mode, $inline_object);
     ...
     */
    public function oauth2AccessTokenPostAsync($content_type, $x_debug_mode = null, $inline_object = null)
    {
        return $this->oauth2AccessTokenPostAsyncWithHttpInfo($content_type, $x_debug_mode, $inline_object)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function oauth2AccessTokenPostAsyncWithHttpInfo($content_type, $x_debug_mode = null, $inline_object = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse200';
        $request = $this->oauth2AccessTokenPostRequest($content_type, $x_debug_mode, $inline_object);
     ...
     */
    protected function oauth2AccessTokenPostRequest($content_type, $x_debug_mode = null, $inline_object = null)
    {
        // verify the required parameter 'content_type' is set
        if ($content_type === null || (is_array($content_type) && count($content_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $content_type when calling oauth2AccessTokenPost'
            );
        }
